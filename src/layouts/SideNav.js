...
<div style={{ borderLeft: "2px solid #6c757d", marginLeft: "5px" }}>
  ...
  <li className="nav-item" style={{ paddingLeft: "10px" }}>
    <button className="flex gap-2 ml-2 mt-2 p-1 text-start w-full hover:rounded-md text-white hover:bg-gray-600 hover:text-white transition duration-200" onClick={() => onOpenTab("settingspackage", "Package Settings", <PackageSettings></PackageSettings>)}>
  ...
  <li className="nav-item" style={{ paddingLeft: "10px" }}>
    ...
    <li className="nav-item" style={{ borderLeft: "2px solid #6c757d", marginLeft: "5px", paddingLeft:"5px" }}>
      <button className="flex gap-2 p-2 text-start w-full hover:rounded-md text-white hover:bg-gray-600  hover:text-white transition duration-200" onClick={() => onOpenTab("usersetup", "UserSetup", <UserSetup></UserSetup>)}>
      <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="size-5">
